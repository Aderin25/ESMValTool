...
from esmvaltool.diag_scripts.droughtindex.collect_spi_func import (
    runs_of_ones_array, runs_of_ones_array_spi, get_latlon_index, 
    count_spells, plot_map_spi_multi, plot_map_spi, plot_time_series_spi)
...
def main(cfg):
    ...
    for iii, spi_file in enumerate(glob.iglob(input_filenames)):
        ...
        # Calls a python program which makes the plot of time series (1D) of SPI (see above).
