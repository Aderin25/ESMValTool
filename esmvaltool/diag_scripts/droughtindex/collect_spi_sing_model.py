...
def main(cfg):
    ...
    for spi_file in glob.iglob(input_filenames):
        ...
        # print("cube2")
        # print(cube2)#Prints information about the average cube #does it mean for cube2,the coordinate which is time was separately compressed to 2D 
        # and same for cube 3,the coordinate which is longitude and latitude experienced 3d to 1d?
        ...
        if lasttime > timecheck:
            ...
            plot_map_spi(cfg, cube2, drought_numbers_level, add_to_filename = 'Historic_Number_of_Events', name = 'Historic_Number of Events per year')
            ...
            drought_numbers_level = np.arange(-4, 0, 0.25) # set color levels
            # use cube2 to get metadata
            ...
            # use cube2 to get metadata
            cube2.data = drought_periods.data[:,:,0] / time_length
            plot_map_spi(cfg, cube2, drought_numbers_level, add_to_filename = 'RCP85_Number_of_Events', name = 'RCP85_Number of Events per year')
