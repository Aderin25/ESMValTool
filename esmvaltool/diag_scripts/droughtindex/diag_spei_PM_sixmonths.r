...
for (mod in 1:nmods){
   ...
   if (rh_flag){
     xprov$ancestors <- list(modfile1[mod], modfiletasmin[mod], modfiletasmax[mod], modfilewind[mod], modfilers[mod], modfilepsl[mod], modfilerh[mod])
   }else{
     xprov$ancestors <- list(modfile1[mod], modfiletasmin[mod], modfiletasmax[mod], modfilewind[mod], modfilers[mod], modfilepsl[mod])
   }
